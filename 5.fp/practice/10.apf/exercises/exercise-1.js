...
import { Container, curry } from './containers.js';
...
//
// Используй ТОЛЬКО ap (не доставай значения вручную через ._value).
//
...
const greet = curry((greeting, name, punctuation) => `${greeting}, ${name}${punctuation}`);
