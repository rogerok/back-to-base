...
import { safeAdd, safeCreateDate, safeFullName, safeMultiply3 } from './exercise-2.ts';

const isNothing = <A>(value: Maybe<A>): boolean => value instanceof Maybe && value.isNothing;
const valueOf = <A>(value: Maybe<A>): A | null | undefined => value.value;
